          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-sm font-bold text-white flex items-center gap-2">
                ⚡ Resultado do Teste de 3 Segundos
        ...
        <div className="p-6 overflow-y-auto flex-1 grid grid-cols-12 gap-6">
          ...
          <div className="col-span-6 space-y-3">
            <div className="relative aspect-[9/16] w-full max-h-[380px] bg-black rounded-xl overflow-hidden border border-[#262632] flex items-center justify-center group mx-auto">
              <video
                src={job.videoUrl || 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4'}
            ...
            <div className="text-center">
              ...
              <div className="text-[10px] text-zinc-400">Provider: {job.providerUsed || 'Runway Gen-3 Alpha'}</div>
            </div>
          </div>
          ...
          <div className="col-span-6 space-y-4">
            ...
            {/* Quality Checklist */}
            <div className="bg-[#0E0E12] border border-[#1E1E26] p-3 rounded-xl space-y-2 text-xs">
