...
export async function GET() {
  const required = { database: ['SUPABASE_URL', 'SUPABASE_SERVICE_ROLE_KEY'], encryption: ['SOCIAL_TOKEN_ENCRYPTION_KEY'], instagram: ['META_APP_ID', 'META_APP_SECRET', 'META_REDIRECT_URI'], tiktok: ['TIKTOK_GATEWAY_URL', 'TIKTOK_HANDOFF_SECRET'], worker: ['CRON_SECRET'], tenancy: ['DEFAULT_TEAM_ID'] };
